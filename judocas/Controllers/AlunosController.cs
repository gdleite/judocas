...
//            aluno.Faixa = _context.Faixas.Where(o => o.IdAluno == id).Distinct().ToList();
//            aluno.RG = _context.RG.Where(t => t.IdAluno == id).Distinct().Single();
//            aluno.Endereco = _context.Enderecos.Where(t => t.IdAluno == id).Distinct().Single();
