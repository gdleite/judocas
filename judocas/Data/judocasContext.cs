...
namespace judocas.Data
{
    public class judocasContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Endereco>().Property(a => a.IdFiliado).HasColumnType("BIGINT").HasColumnName("ID_FILIADO").IsRequired();
            ...
            modelBuilder.Entity<Endereco>().HasOne(a => a.Filiado).WithOne(a => a.Endereco).HasForeignKey<Filiado>(a => a.IdFiliado);
